...
const Phil = () => {
  return (
    ...
    <img src={phil} alt="image of phil" className="phil-img" />
    ...
    <section className="phil-description">
      ...
      <p>I'm always looking for new ways to learn more! Feel free to reach out to me on LinkedIn or view my GitHub.</p>
    </section>
